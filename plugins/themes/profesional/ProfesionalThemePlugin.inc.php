...
class ProfesionalThemePlugin extends ThemePlugin {
	/**
	...
	public function init() {
		...
		$this->addOption('typography', 'radio', array(
			'label' => 'plugins.themes.profesional.option.typography.label',
			'description' => 'plugins.themes.profesional.option.typography.description',
			'options' => array(
				'notoSans' => 'plugins.themes.profesional.option.typography.notoSans',
				'notoSerif' => 'plugins.themes.profesional.option.typography.notoSerif',
				'notoSerif_notoSans' => 'plugins.themes.profesional.option.typography.notoSerif_notoSans',
				'notoSans_notoSerif' => 'plugins.themes.profesional.option.typography.notoSans_notoSerif',
				'lato' => 'plugins.themes.profesional.option.typography.lato',
				'lora' => 'plugins.themes.profesional.option.typography.lora',
				'lora_openSans' => 'plugins.themes.profesional.option.typography.lora_openSans',
			)
		));

		$this->addOption('baseColour', 'colour', array(
			'label' => 'plugins.themes.profesional.option.colour.label',
			'description' => 'plugins.themes.profesional.option.colour.description',
			'profesional' => '#1E6292',
		));
		...
		$this->addScript('profesional', 'js/main.js');
	...
	function getDisplayName() {
		return __('plugins.themes.profesional.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.profesional.description');
	}
}

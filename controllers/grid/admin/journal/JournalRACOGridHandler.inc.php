...
import('controllers.grid.admin.journal.form.JournalRACOSiteSettingsForm');

class JournalRACOGridHandler extends ContextGridHandler {
	...
	function editContext($args, $request) {
		...
		// Form handling.
		$settingsForm = new JournalRACOSiteSettingsForm(!isset($journalId) || empty($journalId) ? null : $journalId);
	...
	function updateContext($args, $request) {
		...
		// Form handling.
		$settingsForm = new JournalRACOSiteSettingsForm($contextId);

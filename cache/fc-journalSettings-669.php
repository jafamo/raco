...
<a href="{$contextUrl}">{$contextName}</a>',
  ...
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="http://localhost:800/ojs/index.php/testing/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="http://localhost:800/ojs/index.php/testing/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="http://localhost:800/ojs/index.php/testing/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="http://localhost:800/ojs/index.php/testing/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="http://localhost:800/ojs/index.php/testing/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="http://localhost:800/ojs/index.php/index/login">log in</a> and begin the five-step process.',
  ),
  ...
  'name' => 
  array (
    'en_US' => 'Journal testing 2018',
    'ca_ES' => 'journal testing2018',
  ),
  'description' => 
  array (
    'en_US' => '<p>Testing journal 2018</p>',
  ),
); ?>